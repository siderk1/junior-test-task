...
export class MetricsService {
  ...
  public readonly acceptedEvents = new Counter({
    ...
    help: 'Total events accepted by the Facebook collector',
    registers: [this.registry]
  });

  public readonly processedEvents = new Counter({
    name: 'fb_collector_events_processed_total',
    help: 'Total events successfully processed by the Facebook collector',
    registers: [this.registry]
  });

  public readonly failedEvents = new Counter({
    name: 'fb_collector_events_failed_total',
    help: 'Total events failed in the Facebook collector',
    registers: [this.registry]
  });
