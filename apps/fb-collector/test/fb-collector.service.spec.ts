...
describe('FbCollectorService', () => {
  ...
  describe('handleEvent', () => {
    it('should upsert location, user, and create event (top funnel)', async () => {
      ...
      mockPrismaService.facebookEngagementTop.create.mockResolvedValue({
        id: 3
      });
    ...
    it('should correctly handle bottom funnel', async () => {
      ...
      mockPrismaService.facebookEngagementBottom.create.mockResolvedValue({
        id: 12
      });
      mockPrismaService.facebookEvent.create.mockResolvedValue({});
      ...
      expect(
        mockPrismaService.facebookEngagementBottom.create
      ).toHaveBeenCalled();
      expect(
        mockPrismaService.facebookEngagementTop.create
